...
public class Solitaire extends JPanel implements Game {
    ...
    public Solitaire() {
        ...
        frame.setPreferredSize(new Dimension(Blackjack.SCREEN_X, Blackjack.SCREEN_Y));
    ...
    public void newGame() {
        ...
        deck = new Deck();
        deck.shuffle();
        deck.setBounds(60, 35, Card.CARD_WIDTH, Card.CARD_HEIGHT);
        add(deck);
        piles.clear();
        Waste waste = new Waste(deck);
        waste.setBounds(160, 35, Card.CARD_WIDTH, Card.CARD_HEIGHT);
        ...
        for (int i = 0; i < 4; i++) {
            ...
            foundationToAdd.setBounds(357 + 20 * i + i * Card.CARD_WIDTH, 35, Card.CARD_WIDTH, Card.CARD_HEIGHT);
        ...
        for (int i = 0; i < 7; i++) {
            ...
            toAdd.setBounds(60 + (20 * i) + (i * Card.CARD_WIDTH), 178, Card.CARD_WIDTH, (i * 25) + Card.CARD_HEIGHT);
    ...
    private class Mouse extends MouseInputAdapter {
        ...
        public void mouseMoved(MouseEvent e) {
            p = e.getPoint();
            pp = SwingUtilities.convertPoint(sourcePile, e.getPoint(), Solitaire.this);
        ...
        public void mousePressed(MouseEvent e) {
            ...
            if (clicks % 2 == 0) {
                ...
                if (clickedCard != null && destinationPile.isValidMove(clickedCard) && tempList.size() == 1) {
                ...
                } else if (clickedCard != null && destinationPile.isValidMove(clickedCard) && tempList.size() > 1
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            if (clickCount == 2 && clickedCard != null) {
                for (SolitairePile stack : Solitaire.this.piles) {
                    if (((stack instanceof Foundation)) && (stack.isValidMove(clickedCard))
