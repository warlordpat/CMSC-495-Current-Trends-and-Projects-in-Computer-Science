...
public class MainCGS extends JPanel {
    ...
    public final void gui() {
        ...
        Suits = null;
        try {
            Suits = ImageIO.read(getClass().getClassLoader().getResource("images/Suits.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        jbBlackjack.setBounds(BUTTON_X, BLACKJACK_Y, BUTTON_WIDTH, BUTTON_HEIGHT);
        jbThirtyOne.setBounds(BUTTON_X, THIRTYONE_Y, BUTTON_WIDTH, BUTTON_HEIGHT);
        jbConcentration.setBounds(BUTTON_X, CONCENTRATION_Y, BUTTON_WIDTH, BUTTON_HEIGHT);
        jbHighLow.setBounds(BUTTON_X, HIGHLOW_Y, BUTTON_WIDTH, BUTTON_HEIGHT);
        jbSolitaire.setBounds(BUTTON_X, SOLITAIRE_Y, BUTTON_WIDTH, BUTTON_HEIGHT);
    ...
    /**
     * Creates a new message pane stating the authors's names and each of the games' information
     */
    private void about() {
