 ...
 * compare your hand against the computer's to see which is closer to Thirty-One.
 *
 * @author Alex Burch
 * @version 1.0
 * @since Sep 1, 2016
...
public class ThirtyOne extends JPanel implements Game {
    ...
    **/
    ...
    private void setCards() {
        ...
        jbCenterCard1 = new JButton(new ImageIcon(centerCard1.front));
        jbCenterCard2 = new JButton(new ImageIcon(centerCard2.front));
        jbCenterCard3 = new JButton(new ImageIcon(centerCard3.front));
        jbPlayerCard1 = new JButton(new ImageIcon(playerCard1.front));
        jbPlayerCard2 = new JButton(new ImageIcon(playerCard2.front));
        jbPlayerCard3 = new JButton(new ImageIcon(playerCard3.front));
            ...
            if (values.get(aiCard1.getRank()) < values.get(aiCard2.getRank()))//1<2
            {
                if (values.get(aiCard1.getRank()) < values.get(aiCard3.getRank()))//1<3
                {
                    if (values.get(aiCard1.getRank()) < values.get(aiCard4.getRank()))//1<4
                    {
                        ...
                        {
                            jbCenterCard1 = new JButton(new ImageIcon(aiCard1.front));
                            jbCenterCard1.setVisible(true);
                        }
                        else if(!jbCenterCard2.isVisible())
                        {
                            jbCenterCard2 = new JButton(new ImageIcon(aiCard1.front));
                            jbCenterCard2.setVisible(true);
                        }
                        else
                        {
                            jbCenterCard3 = new JButton(new ImageIcon(aiCard1.front));
                    ...
                    else 
                    {
                        ...
                        if(!jbCenterCard1.isVisible())
                        {
                            jbCenterCard1 = new JButton(new ImageIcon(aiCard4.front));
                            jbCenterCard1.setVisible(true);
                        }
                        else if(!jbCenterCard2.isVisible())
                        {
                            jbCenterCard2 = new JButton(new ImageIcon(aiCard4.front));
                            jbCenterCard2.setVisible(true);
                        }
                        else
                        {
                            jbCenterCard3 = new JButton(new ImageIcon(aiCard4.front));
                            jbCenterCard3.setVisible(true);
                        }
                    }
                }
                else
                {
                    if (values.get(aiCard3.getRank()) < values.get(aiCard4.getRank()))//3<4
                    {
                        if(!jbCenterCard1.isVisible())
                        {
                            jbCenterCard1 = new JButton(new ImageIcon(aiCard3.front));
                            jbCenterCard1.setVisible(true);
                        }
                        else if(!jbCenterCard2.isVisible())
                        {
                            jbCenterCard2 = new JButton(new ImageIcon(aiCard3.front));
                            jbCenterCard2.setVisible(true);
                        }
                        else
                        {
                            jbCenterCard3 = new JButton(new ImageIcon(aiCard3.front));
                            jbCenterCard3.setVisible(true);
                        }
                    }
                    else
               ...
               if (values.get(aiCard2.getRank()) < values.get(aiCard3.getRank()))//2<3
                {
                    if (values.get(aiCard2.getRank()) < values.get(aiCard4.getRank()))//2<4
                    {
                        if(!jbCenterCard1.isVisible())
                        {
                            jbCenterCard1 = new JButton(new ImageIcon(aiCard2.front));
                            jbCenterCard1.setVisible(true);
                        }
                        else if(!jbCenterCard2.isVisible())
                        {
                            jbCenterCard2 = new JButton(new ImageIcon(aiCard2.front));
                            jbCenterCard2.setVisible(true);
                        }
                        else
                        {
                            jbCenterCard3 = new JButton(new ImageIcon(aiCard2.front));
                            jbCenterCard3.setVisible(true);
                        }
                    }
                    else 
    ...
    private void cardButtons() {
        jbCenterCard1.addActionListener(ae -> {
            if (player.handSize() < 4) {
                ...
                jbPlayerCard4 = new JButton(new ImageIcon(centerCard1.front));
        ...
        jbCenterCard2.addActionListener(ae -> {
            if (player.handSize() < 4) {
                ...
                jbPlayerCard4 = new JButton(new ImageIcon(centerCard2.front));
                jbPlayerCard4.setBounds(450, 300, CARD_WIDTH, CARD_HEIGHT);
                add(jbPlayerCard4);
                remove(jlPlayerHand);
                playerHand = player.thirtyOneTotal();
        ...
        jbCenterCard3.addActionListener(ae -> {
            if (player.handSize() < 4) {
                ...
                jbPlayerCard4 = new JButton(new ImageIcon(centerCard3.front));
                jbPlayerCard4.setBounds(450, 300, CARD_WIDTH, CARD_HEIGHT);
                add(jbPlayerCard4);
                remove(jlPlayerHand);
                playerHand = player.thirtyOneTotal();
    ...
    public void loadGame() {
        ...
        try (FileInputStream fileStream = new FileInputStream("ThirtyOne.ser");
            ...
            jbCenterCard3.setBounds(350, 100, CARD_WIDTH, CARD_HEIGHT);
            add(jbCenterCard3);
            jbPlayerCard1 = new JButton(new ImageIcon(player.getCard(0).front));
            jbPlayerCard1.setBounds(150, 300, CARD_WIDTH, CARD_HEIGHT);
            add(jbPlayerCard1);
            jbPlayerCard2 = new JButton(new ImageIcon(player.getCard(1).front));
            jbPlayerCard2.setBounds(250, 300, CARD_WIDTH, CARD_HEIGHT);
            add(jbPlayerCard2);
            jbPlayerCard3 = new JButton(new ImageIcon(player.getCard(2).front));
            jbPlayerCard3.setBounds(350, 300, CARD_WIDTH, CARD_HEIGHT);
            add(jbPlayerCard3);
            iTurn = os.readInt();
    ...
    /**
     * Decides which player wins, sees if the player wants to play again,
     * and starts a new game or checks to see if they made the high score
     */
