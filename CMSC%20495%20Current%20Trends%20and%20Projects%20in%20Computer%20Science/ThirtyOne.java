    ...
    **/
    ...
    private void setCards() {
        ...
        if (iTurn == 0)
        {
            ...
            {
                if (values.get(aiCard1.getRank()) < values.get(aiCard3.getRank()))
                {
                    if (values.get(aiCard1.getRank()) < values.get(aiCard4.getRank()))
                    {
                ...
                {
                    if (values.get(aiCard3.getRank()) < values.get(aiCard4.getRank()))
                    {
                        if(!jbCenterCard1.isVisible())
                        {
            ...
            {
               if (values.get(aiCard2.getRank()) < values.get(aiCard3.getRank()))
                {
                    if (values.get(aiCard2.getRank()) < values.get(aiCard4.getRank()))
                    {
                        if(!jbCenterCard1.isVisible())
                        {
        ...
        jbCenterCard1.setBounds(CARD_X_1, CENTER_CARD_Y, CARD_WIDTH, CARD_HEIGHT);
        add(jbCenterCard1);
        jbCenterCard2.setBounds(CARD_X_2, CENTER_CARD_Y, CARD_WIDTH, CARD_HEIGHT);
        add(jbCenterCard2);
        jbCenterCard3.setBounds(CARD_X_3, CENTER_CARD_Y, CARD_WIDTH, CARD_HEIGHT);
        add(jbCenterCard3);
        ...
        add(jlPlayer);
        jbPlayerCard1.setBounds(CARD_X_1, PLAYER_CARD_Y, CARD_WIDTH, CARD_HEIGHT);
        add(jbPlayerCard1);
        jbPlayerCard2.setBounds(CARD_X_2, PLAYER_CARD_Y, CARD_WIDTH, CARD_HEIGHT);
        add(jbPlayerCard2);
        jbPlayerCard3.setBounds(CARD_X_3, PLAYER_CARD_Y, CARD_WIDTH, CARD_HEIGHT);
        add(jbPlayerCard3);
    ...
    private void cardButtons() {
        jbCenterCard1.addActionListener(ae -> {
            if (player.handSize() < MAX_HAND) {
                ...
                jbPlayerCard4 = new JButton(new ImageIcon(playerCard4.getFront()));
                jbPlayerCard4.setBounds(CARD_X_4, PLAYER_CARD_Y, CARD_WIDTH, CARD_HEIGHT);
                add(jbPlayerCard4);
                remove(jlPlayerHand);
                playerHand = player.thirtyOneTotal();
                jlPlayerHand.setText("Value: " + String.valueOf(playerHand));
    ...
    private void switchCards() {
        ...
        jbPlayerCard1.addActionListener(ae -> {
            if (player.handSize() > MIN_HAND) {
                ...
                remove(jbPlayerCard1);
                jbPlayerCard2.setBounds(CARD_X_1, PLAYER_CARD_Y, CARD_WIDTH, CARD_HEIGHT);
                jbPlayerCard3.setBounds(CARD_X_2, PLAYER_CARD_Y, CARD_WIDTH, CARD_HEIGHT);
                jbPlayerCard4.setBounds(CARD_X_3, PLAYER_CARD_Y, CARD_WIDTH, CARD_HEIGHT);
                revalidate();
                repaint();
                results();
            }
