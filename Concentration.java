...
public class Concentration extends JFrame implements MouseListener, ActionListener, Game {
    ...
    int attempts;
    /**
     * The time the game was started. Used to display total time at the end of a game.
     */
    long timeStart;
    /**
     * The time the game was finished. Used to display total time at the end of a game.
     */
    long timeEnd;
    /**
     * Saves the elapsed time of a saved game so it can be added when game is resumed.
     */
    long elapsedTime = 0;
    /**
     * Remains true until first pair is flipped, then is assigned false.
     * When firstCard = false, the scorePanel becomes visible.
     */
    boolean firstCard;
    /**
     * Container for deck.
    ...
    JLabel[] cardLabels;
    /**
     * Used by the loadGame method to determine if a card had already been matched.
     */    
    ...
    /**
     * Saves the value of the selected card. If it is the second selected card, compares to see if it's a match.
     * If it is, the cards are disabled.  If they do not match, the cards are again placed facedown.
     */
    public void checkForMatch() {
        ...
        if (test == 2) {
            ...
            attempts += 1;   //Every time 2 cards are selected, attempts is increased by 1 for scoring purposes.
            ...
            if (deck.concentrationDeal(secondSelectedCard).toString() == null
                ...
                if (selectedCard != secondSelectedCard) {  //checks to make sure the user didn't click the same card twice.
    ...
    /**
     * Stores the value for each card in an array based on their position on the board.
     * Recreates the array for new games, but not for loaded games.
     */
    ...
    private void reset() {
        ...
        JOptionPane.showMessageDialog(mainPanel, "A new game has been started.", "Concentration", JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    public void saveGame() {
        ...
        try (FileOutputStream filestream = new FileOutputStream("Concentration.ser");
            ...
            JOptionPane.showMessageDialog(mainPanel, "Your game has been saved.","Concentration", JOptionPane.INFORMATION_MESSAGE);
    ...
    public void loadGame() {
        ...
        try (FileInputStream filestream = new FileInputStream("Concentration.ser");
            ...
            JOptionPane.showMessageDialog(mainPanel, "Your game has been loaded.","Concentration", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void directions() {
        JOptionPane.showMessageDialog(mainPanel, "Concentration is played with 30 cards (15 pairs). To play, click on any two cards."
                ...
                + "  See if you can beat your high score by matching all pairs in the least number of moves!","Concentration", JOptionPane.INFORMATION_MESSAGE);
    }
